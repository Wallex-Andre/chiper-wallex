...
<body class="min-h-screen flex flex-col bg-base-200 font-sans">
    ...
    <nav class="navbar bg-base-100">
            ...
            <div class="search">
                <form class="relative max-w-md mx-auto" action="{{ route('search') }}" method="GET">
                    ...
                    <div class="relative">
                        ...
                        <!-- INPUT -->
                        <input type="search" name="query" value="{{ request('query') }}" id="search"
                            placeholder="Search" class="block w-full py-3 pl-10 pr-20
                       bg-base-100 border border-base-300
                       rounded-2xl text-sm text-base-content
                       focus:outline-none focus:ring-0 focus:border-[#5580d2]" />
        ...
        @auth
            ...
            <div class="dropdown dropdown-end mr-2">
                ...
                <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-10 w-52 p-2 shadow">
                    ...
                    <li>
                        <a href="{{ route('user-chirps') }}">Chirps</a>
                    </li>
                    <li>
        ...
        @else
            <a href="{{ route('login') }}" class="btn btn-ghost btn-sm mr-2">Sign In</a>
